 ...
 */
export async function initHDRCanvas(canvas, baseImg, rainbowSrc) {
    if (!('gpu' in navigator)) {
 ...
 * @param rainbowSrc - data URL for rainbow ramp
 */
export async function createSDRFallback(canvas, baseImg, rainbowSrc) {
