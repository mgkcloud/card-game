...
async function createCardPipeline(canvas, img) {
...
function frame(ctx, light, intensity) {
 ...
 */
export async function startRareShine(card, canvas, slider) {
    ...
    function renderLoop() {
        ...
        if ('draw' in ctxOrFallback) {
            ...
            frame(ctxOrFallback, lightDir, intensity);
        }
    }
    renderLoop();
...
async function main() {
    ...
    const canvas = document.querySelector('.rare-shine');
